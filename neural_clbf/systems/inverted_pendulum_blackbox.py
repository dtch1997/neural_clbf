...
from .control_affine_system import BlackboxControlAffineSystem
from neural_clbf.systems.utils import grav, Scenario, ScenarioList


class InvertedPendulumBlackbox(BlackboxControlAffineSystem):
    """
    ...
    @property
    def n_dims(self) -> int:
        return InvertedPendulumBlackbox.N_DIMS

    @property
    def angle_dims(self) -> List[int]:
        return [InvertedPendulumBlackbox.THETA]

    @property
    def n_controls(self) -> int:
        return InvertedPendulumBlackbox.N_CONTROLS
    ...
    def state_limits(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        upper_limit[InvertedPendulumBlackbox.THETA] = 2.0
        upper_limit[InvertedPendulumBlackbox.THETA_DOT] = 2.0
    ...
    def _f(self, x: torch.Tensor, params: Scenario):
        ...
        # and state variables
        theta = x[:, InvertedPendulumBlackbox.THETA]
        theta_dot = x[:, InvertedPendulumBlackbox.THETA_DOT]

        # The derivatives of theta is just its velocity
        f[:, InvertedPendulumBlackbox.THETA, 0] = theta_dot

        # Acceleration in theta depends on theta via gravity and theta_dot via damping
        f[:, InvertedPendulumBlackbox.THETA_DOT, 0] = (
    ...
    def _g(self, x: torch.Tensor, params: Scenario):
        ...
        # Effect on theta dot
        g[:, InvertedPendulumBlackbox.THETA_DOT, InvertedPendulumBlackbox.U] = 1 / (m * L ** 2)
