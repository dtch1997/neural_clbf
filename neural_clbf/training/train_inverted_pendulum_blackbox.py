...
from neural_clbf.systems import InvertedPendulumBlackbox
...
def main(args):
    ...
    V_contour_experiment = CLFContourExperiment(
        ...
        n_grid=30,
        x_axis_index=InvertedPendulumBlackbox.THETA,
        y_axis_index=InvertedPendulumBlackbox.THETA_DOT,
        x_axis_label="$\\theta$",
    ...
    rollout_experiment = RolloutStateSpaceExperiment(
        "Rollout",
        start_x,
        InvertedPendulumBlackbox.THETA,
        "$\\theta$",
        InvertedPendulumBlackbox.THETA_DOT,
        "$\\dot{\\theta}$",
        scenarios=scenarios,
        n_sims_per_start=1,
        t_sim=5.0,
    ...
    if args.track:
        ...
        run = wandb.init(
            ...
            name='inverted_pendulum_blackbox',
        )
    
    # Initialize the logger and trainer
    logger = pl_loggers.TensorBoardLogger(
        "logs/inverted_pendulum_blackbox",
